...
{pergunta:"Na integração on-line de documentos da Logística para a Contabilidade é possível criar classes de IVA?",opcoes:["A criação de novas classes de IVA pode ser realizada em qualquer opção que permita aceder ao Plano de IVA.","Não é possível criar novas classes de IVA através do editor de integração dos movimentos na Contabilidade.","Não, porque essa função só está disponível na Contabilidade.","Sim, desde que na coluna das classes de IVA indique uma classe de IVA que não existe no Plano de IVA."],correta:1},
{pergunta:"Indique se é possível integrar os lançamentos contabilísticos de vendas numa situação em que a conta “71 - vendas” está dividida por secções.",opcoes:["É possível desde que esteja seleccionada a opção “Utiliza secções de venda da Logística”.","É possível, desde que o token relativo às secções de venda esteja devidamente configurado.","Não é possível porque não existe nenhum token que permita essa desagregação.","Não é possível porque não existe nenhum token relativo às secções de venda."],correta:0},
{pergunta:"Indique a opção correcta.",opcoes:["A integração das vendas dos artigos do tipo ´Imobilizado´ na contabilidade utiliza os tokens referidos nas alíneas anteriores.","A opção ´Deduz IVA´ está disponível para os artigos que sejam do tipo ´imobilizado´ e pode influenciar o valor sujeito a amortização/reintegração a considerar na ficha dos bens de Imobilizado.","O IVA associado aos artigos do tipo ´Imobilizado´ é integrado na Contabilidade utilizando o Tokem ´IVA´.","O valor dos artigos do tipo ´Imobilizado´ é integrado na contabilidade utilizado o token ´MER´."],correta:0},
{pergunta:"Um documento de alienação de imobilizado registado na Logística, só poderá ser integrado nos Equipamentos e Activos se:",opcoes:["Esse bem não estiver amortizado ou reintegrado no período em que se pretende registar o documento de alienação.","O bem de imobilizado já estiver totalmente amortizado ou reintegrado e o documento estiver configurado para efectuar a integração.","O documento estiver configurado para integrar no Imobilizado.","Se existir uma conta corrente de fornecedores de imobilizado para integrar o documento de alienação."],correta:0},
{pergunta:"Supondo que se quer integrar movimentos de qualquer módulo do ERP para a Contabilidade, seleccione a opção correcta:",opcoes:["É possível configurando a ligação na própria aplicação.","É possível efectuar a integração, configurando a ligação no administrador e realizando a exportação através da opção ´Movimentos Diferidos´.","É possível configurando a ligação no administrador e realizando a exportação através dos “serviços” do Administrador.","É possível mas só na “passagem de ano”."],correta:0},
{pergunta:"Suponha que pretende integrar movimentos na Contabilidade. Seleccione a opção correcta:",opcoes:["É possível integrar movimentos procenientes da Logística, Recursos Humanos e Equipamentos e Activos.","Só é possível integrar movimentos provenientes da Logística.","É possível mas só na “passagem de ano”.","Não é possível integrar movimentos na Contabilidade."],correta:0},
{pergunta:"Para integrar os pedidos de reembolso de IVA nas contas correntes da Logística deve:",opcoes:["Activar a opção no Administrador, configurar o documento de integração e realizar o apuramento do IVA.","Activar essa opção na Ligação à Contabilidade.","Indicar a entidade associada na Logística.","Nenhuma das opções está correcta."],correta:0},
{pergunta:"A informação ´Deduz Iva´ da ficha de artigo, é utilizado quando:",opcoes:["O artigo for do tipo imobilizado e se pretende considerar ou não o IVA para cálculo do valor sujeito a amortização.","O artigo for do tipo mercadorias e se pretende registar compras desse artigo no mercado intracomunitário com integração do movimento na Contabilidade.","O artigo for do tipo, matérias-primas e se pretende realizar a composição das matérias-primas em produtos acabados.","O artigo for sujeito a inventariação e não se pretende considerar o I.V.A. nos acertos de inventário."],correta:0},
{pergunta:"Considere que determinada empresa trabalha exclusivamente com o mercado nacional. Indique que configurações devem ser definidas para integrar os documentos de venda, do tipo “FA - Factura”, considerando que o Plano de Contas ainda mantém referência ao mercado nacional nas contas de cliente.",opcoes:["Neste caso, o token “D”, correspondente aos diferentes tipos de mercado, não pode ser retirado porque a sua posição na configuração da conta de integração é variável.","O token “D”, correspondente aos diferentes tipos de mercado pode ser retirado, desde que seja substituído pelo número que permite integrar os movimentos no Plano de Contas.","O token “D”, correspondente aos diferentes tipos de mercado, pode ser mantido na configuração do movimento contabilístico associado ao documento “FA”, mas apenas se a tabela “Tipos de Mercado” não estiver preenchida.","Os números correspondentes aos diferentes tipos de mercado não são visíveis nem controláveis pelo utilizador. Por isso, a diferenciação dos tipos de mercado é feito pelo sistema, não existindo nenhum token para o efeito."],correta:0},
{pergunta:"Enquadre a configuração da ligação dos Documentos Bancários à Contabilidade, seleccionado a resposta certa.",opcoes:["A parametrização da ligação à Contabilidade é efectuada exclusivamente no “Administrador”. A “Logística” permite efectuar a integração dos documentos bancários, através da opção “Movimentos Diferidos”.","A parametrização desta ligação é efectuada no “Administrador”, a partir da opção “Parâmetros da Logística”. Nesta opção deve indicar-se qual a perspectiva a utilizar (Bancária/Contabilística) nos lançamentos contabilísticos.","Esta configuração é efectuada na opção “Movimentos Bancários” da “Logística” e no “Administrador”. A “Ligação à Contabilidade” definido no “Administrador” permite estabelecer quais os documentos têm ligação à contabilidade, quais as contas a movimentar e qual o tipo de ligação pretendida (On-line/Off-Line).","Na Logística deve ser indicada qual a “Rubrica Bancária” a movimentar em cada documento. No “Administrador” são indicadas as contas da contabilidade e a perspectiva a utilizar na integração dos movimentos."],correta:0},
{pergunta:"Considere que determinada empresa está no regime mensal de IVA e que integra na Contabilidade, utilizando o tipo de ligação “On-line”, todos os documentos emitidos na Logística. Indique se o IVA associado a um documento que foi registado no mês ´n´, pode ser apurado no mês n+1.",opcoes:["Não, porque o programa não tem essa funcionalidade.","Nenhuma das opções está correcta.","Sim. Mas este procedimento não deve ser aplicado se a empresa utilizar o sistema de inventário permanente.","Só se a empresa estiver em regime de Isenção de IVA."],correta:0},
